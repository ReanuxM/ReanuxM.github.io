  ...
  <div class="case-study-body">
    ...
    <div class="case-study-cta reveal">
      ...
      <div class="case-study-cta-links">
        ${cs.repoUrl ? `<a href="${cs.repoUrl}" target="_blank" rel="noopener" class="btn btn-primary">View Notebook →</a>\n        <a href="../resume.pdf" download class="btn btn-ghost">Download Resume</a>` : `<a href="../resume.pdf" download class="btn btn-primary">Download Resume</a>`}
